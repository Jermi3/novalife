            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-8 pb-12 border-b border-gray-800">
                    ...
                    <div className="col-span-2 md:col-span-1">
                        <Link href="/" className="flex items-center gap-2 mb-4">
                            ...
                            <span className="text-2xl font-bold text-white">NovaLife</span>
                        </Link>
                        <p className="text-gray-400 mb-6">
                            Transforming lives through expert coaching, personalized nutrition, and science-backed fitness programs.
                        </p>
                        {/* Social Links */}
                ...
                <div className="pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-gray-500 text-sm">
                        © {new Date().getFullYear()} NovaLife Wellness. All rights reserved.
                    </p>
                    <p className="text-gray-500 text-sm">
